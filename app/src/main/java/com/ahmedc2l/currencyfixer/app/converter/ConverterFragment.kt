...
class ConverterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.amount.observe(viewLifecycleOwner){
            viewModel.convertCurrencies(it, viewModel.fromCountryIndex.value, viewModel.toCountryIndex.value)
        }
        ...
        viewModel.toCountryIndex.observe(viewLifecycleOwner){
            viewModel.convertCurrencies(viewModel.amount.value, viewModel.fromCountryIndex.value, it)
        }
